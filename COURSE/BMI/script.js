...
const weight = prompt("Указите свой вес в килограммах:");
const height = prompt("Указите свой рост в метрах:");
...
if (bmi <= 24.9) {
  ...
  alert("У вас большой вес! Обратитесь к врачу!");
  console.log("У вас большой вес! Обратитесь к врачу!");
}
